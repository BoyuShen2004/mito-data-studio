...
[User guide](../user-guide.md) · Previous: [Submit and review](07-submit-and-review.md) · Next: [Guide index](../user-guide.md)
...
Managers can create revocable shares for projects, datasets, and volumes. A
